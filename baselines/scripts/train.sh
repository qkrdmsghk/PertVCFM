...
if [ "$DATASET_NAME" = "replogle" ]; then
    if [ "$FOLD_ID" = "1" ]; then
        DATA_TOML_PATH="/home/yinhua/CellPertQA/state-sets-reproduce/baselines/state_sets_reproduce/configs/splits/replogle_hepg2.toml"
    elif [ "$FOLD_ID" = "2" ]; then
        DATA_TOML_PATH="/home/yinhua/CellPertQA/state-sets-reproduce/baselines/state_sets_reproduce/configs/splits/replogle_jurkat.toml"
    elif [ "$FOLD_ID" = "3" ]; then
        DATA_TOML_PATH="/home/yinhua/CellPertQA/state-sets-reproduce/baselines/state_sets_reproduce/configs/splits/replogle_k562.toml"
    elif [ "$FOLD_ID" = "4" ]; then
        DATA_TOML_PATH="/home/yinhua/CellPertQA/state-sets-reproduce/baselines/state_sets_reproduce/configs/splits/replogle_rpe1.toml"
    elif [ "$FOLD_ID" = "-1" ]; then
        DATA_TOML_PATH="/home/yinhua/CellPertQA/state-sets-reproduce/baselines/state_sets_reproduce/configs/splits/k562-seed1.toml"
    fi
