...
DEMO_DATASET_CELL_TYPES = {
    ...
    "RPE1_single_cell_line": ("RPE1", None, "RPE1"),
    'HEPG2_single_cell_line': ("hepg2", None, "hepg2"),
    'JURKAT_single_cell_line': ("jurkat", None, "jurkat"),
    'adamson_single_cell_line': ("K562_adamson", None, "K562_adamson"),
    "perturbqa_K562_single_cell_line": ("K562", None, "K562"),
    "perturbqa_RPE1_single_cell_line": ("RPE1", None, "RPE1"),
    "perturbqa_HEPG2_single_cell_line": ("HEPG2", None, "HEPG2"),
    "perturbqa_JURKAT_single_cell_line": ("JURKAT", None, "JURKAT"),
}
